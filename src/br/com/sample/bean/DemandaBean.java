...
import br.com.sample.service.DemandaService;
...
public class DemandaBean extends EntityBean<Long, Demanda>{
	...
	private void carregarAtendimentos() {
		for(Demanda atd : service.retrieveAll()){
    ...
    public void addEvent(ActionEvent actionEvent) {
        ...
        setEntity(new Demanda());
    }
     
    private Demanda getAtendimento() {
    	Demanda atendimento = service.buscaPorNome(event.getTitle());
    	if(atendimento==null){
    		atendimento = new Demanda();
	...
	@Override
	protected BaseService<Long, Demanda> retrieveEntityService() {
		return this.service;
	}

	@Override
	protected Long retrieveEntityId(Demanda entity) {
		return entity.getId();
	}

	@Override
	protected Demanda createNewEntity() {
		Demanda atendimento = new Demanda();
